...
/**
 * This Class is used as a parser
 */
public class HttpParser {
    ...
    private static final int LF = 0x0A; // 10 (Line Feet)

    /**
     * This method takes the inputStream and it is parsing the data into HttpRequest
     * @param - inputStream
     * @return - HttpRequest
